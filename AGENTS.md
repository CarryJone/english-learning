...
- 自 2026-08-05 起，正式 `article.mp3` 目標時長改為 1 分 45 秒到 2 分 15 秒。以約 250–290 字、28–36 個短句與任務對話維持約兩分鐘；保留自然 A2 語速與每天正好 3 個新字。
- Article 對話正文不顯示 `Staff:`、`Me:` 等角色前綴；以內部 speaker metadata 區分旁白、旅客與工作人員，完整朗讀與逐句音檔必須使用三個不同英文聲音。
