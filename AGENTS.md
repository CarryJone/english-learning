...
- 自 2026-08-03 起，後續正式教材統一以「出國旅遊」為總體情境；英文資訊判讀、搜尋與教學步驟也必須連結行前準備或旅途中會遇到的真實需求。
- Article 的任務敘事預設採第一人稱現場視角，讓學習者能直接跟讀並套用 `I / my` 句型；公告、菜單、訂房規則、網站文字與工作人員說法保留自然語氣，mini dialogue 直接標示說話者。不可為了第一人稱而改寫真實輸入，也不要再以固定第三人稱主角包住整段對話。
- 自 2026-08-04 起，正式 `article.mp3` 目標時長為 2 分 45 秒到 3 分 15 秒。以約 390–430 字、三段式任務流程與目標語塊的控制式重複拉長；維持自然 A2 語速與每天正好 3 個新字，不可只靠放慢 TTS 或增加生詞。
...
- 任務題材應主動分散到機場、入境、交通、問路、旅館、點餐、購物、付款、改票、求助，以及旅行相關搜尋結果、教學步驟、評論與規則，不可長期停留在同質故事或一般居家情境。
- 每篇資訊輸入必須讓學習者找出至少 2 個可驗收資訊，例如時間、地點、價格、限制、下一步或所需條件。
- 文章、片語、單字應優先選高頻、口語、能立即套用的日常英文，不要為了湊題材或湊單字而犧牲自然度。
- 每篇從 Key Phrases 選 2–3 個「今日目標語塊」：高頻且要開口的字做主動產出，較低頻但任務必要的字先做辨識；目標語塊必須貫穿 Article、Key Phrases、Role-play 與 Context Recall，詳細規則以正式 SKILL 為準。
- 每日內容至少要讓學習者明確帶走：
  - 1 句旅行或外出時可直接套用的句子
