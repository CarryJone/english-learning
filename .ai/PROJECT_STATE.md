...
- [x] 已完成 2026-07-20 Day 79 正式教材 Finding the Right Station Exit：3 個新字、34 題 SRS Active Recall、10 題 Context Recall、4 組 Speaking Bridge、Role-play、14 個逐句音檔與首頁入口。
- [x] 已完成 2026-07-21 Day 80 正式教材 Reading a Train Service Notice：3 個新字、5 題 SRS Active Recall、10 題 Context Recall、4 組 Speaking Bridge、Role-play、12 個逐句音檔與首頁入口。
...
- [x] Day 79 任務型正式教材已通過 `validate_daily.py`：79 checks、0 warnings、0 errors。

## 目前 Blocker
- 無。

## 下一步
- 產出 Day 81：先同步最新 SRS，再依能力輪替安排旅行或英文資訊查詢任務。
- Day 81 必須包含 Mission、Role-play 至少 4 回合、Context Recall 至少 8 題，並通過 `validate_daily.py`。
...
- `daily/2026-07-20/`（第三篇任務型正式教材）
- `daily/2026-07-21/`（第四篇任務型正式教材）
- `index.html`
- `profile.json`
