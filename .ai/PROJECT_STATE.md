...
- [x] Day 77–96 已完成二十篇正式任務型教材；最新為 `daily/2026-08-12/` 的 `Choosing a Safe Hotel Breakfast`。
...
- [x] Day 96 目標語塊 `free refills`、`Does this contain nuts?`、`What can I have instead?` 已貫穿 Article、Key Phrases、Role-play 的「你」回合與 Context Recall。
...
## 下一步
- 下一篇先看 Day 96 的理解回饋；若聽力仍低於約六成，優先再減少資訊密度與陌生搭配，不直接降低自然 A2 語速。
