...
- [x] Day 77–100 已完成二十四篇正式任務型教材；最新為 `daily/2026-08-18/` 的 `Checking Carry-on Liquid Rules Before Security`。
...
- [x] 首頁學習記錄的結構錯位已修復；Day 100、Day 99、Day 98 現在同在 `#day-list` 並依日期新到舊排列。

## 目前 Blocker
- 無。

## 下一步
- 下一篇先看 Day 100 的理解回饋；若聽力仍低於約六成，優先再減少資訊密度與陌生搭配，不直接降低自然 A2 語速。
