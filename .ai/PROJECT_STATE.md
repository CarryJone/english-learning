...
- [x] Day 77–104 已完成二十八篇正式任務型教材；最新為 `daily/2026-08-24/` 的 `Finding the Right Airport Train After a Platform Change`。
...
- [x] 首頁 Day 104、Day 103、Day 102 依日期新到舊排列。

## 目前 Blocker
- 無。

## 下一步
- 下一篇先看 Day 104 的理解回饋；若聽力仍低於約六成，優先再減少資訊密度與陌生搭配，不直接降低自然 A2 語速。
