...
- [x] Day 77–94 已完成十八篇正式任務型教材；最新為 `daily/2026-08-10/` 的 `Using a City Bus Day Pass`。
...
- [x] Day 94 目標語塊 `day pass`、`Does this bus go to ...?`、`Please tell me when we get to ...` 已貫穿 Article、Key Phrases、Role-play 的「你」回合與 Context Recall。
...
## 下一步
- 下一篇先看 Day 94 的理解回饋；若聽力仍低於約六成，優先再減少資訊密度與陌生搭配，不直接降低自然 A2 語速。
