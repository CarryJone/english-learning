...
- [x] Day 77–81 已完成五篇正式任務型教材；最新為 `daily/2026-07-22/` 的 `Checking Hotel Breakfast and Luggage`。
- [x] Day 81 已開始 7 篇語塊深化試行（1/7）：目標語塊為 `breakfast is included`、`Can I leave my luggage here?`、`I want to make sure`。
...
## 驗證狀態
- [x] Day 81 通過 `python3 scripts/validate_daily.py 2026-07-22`：79 checks、0 warnings、0 errors。
- [x] Day 81 包含 3 個新字、19 題到期 Active Recall、10 題 Context Recall、4 組 Speaking Bridge、8 回合 Role-play 與 14 個逐句音檔。
- [x] JSON 解析、內嵌 JavaScript 語法、`git diff --check` 與本機 HTTP 頁面 / 音檔 200 均已通過。
- [x] 今日文章共 95 字、14 句，最長句 9 字；目標語塊跨區塊分布已人工確認。

## 目前 Blocker
- 無。

## 下一步
- 產出 Day 82 前先同步最新 SRS，進行語塊深化試行第 2/7 篇，並依本週能力平衡選擇下一個旅行開口或英文資訊判讀任務。
