...
- [x] Day 77–103 已完成二十七篇正式任務型教材；最新為 `daily/2026-08-21/` 的 `Returning a Rental Car with a Full Tank`。
...
- [x] 首頁 Day 103、Day 102、Day 101 依日期新到舊排列。

## 目前 Blocker
- 無。

## 下一步
- 下一篇先看 Day 103 的理解回饋；若聽力仍低於約六成，優先再減少資訊密度與陌生搭配，不直接降低自然 A2 語速。
